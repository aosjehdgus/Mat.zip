(function () {
        ...
        a.inherits
            ...
            : (
                ...
                b.prototype.listenTo = function (a, b, c) {
                    ...
                    a
                        .events[b]
                        .push({handler: c, scope: this})
                },
                b.prototype.addListener = function (a, b, c) {
                    this.removeListener(this, a, b);
                    a && this.events[a] && this
                        .events[a]
                        .push({handler: b, scope: c})
                },
    ...
    d.applyLang = function (a, b) {
        ...
        b.amString = "am";
        b.pmString = "pm";
        c && (c = c[a]) && (d.lang = c, b.langObj = c, c.monthNames && (
        ...
        ), c.am && (b.amString = c.am), c.pm && (b.pmString = c.pm));
    ...
    d.handleWheel = function (a) {
        for (var b = d.charts, c = 0; c < b.length; c++) {
            var e = b[c];
            if (e && e.mouseIsOver) {
                (e.mouseWheelScrollEnabled || e.mouseWheelZoomEnabled) && e.handleWheel && (
                    e.handleMouseMove(a),
                    e.handleWheel(a)
                );
                break
    ...
    d.addGlobalListeners = function () {
        d.globalListenersAdded || (d.globalListenersAdded = !0, d.isNN && (
    ...
    d.addWheelListeners = function () {
        d.wheelIsListened || (
            d.isNN && (window.addEventListener("DOMMouseScroll", d.handleWheel, {
                passive: !1,
                useCapture: !0
...
(function () {
        ...
        for (a = (k = a.split(/\r\n|\n|\r/)).length; ++g < a; k[g] += h) {
            ...
            for (k[g] = ""; h.length > b; k[g] += d.trim(h.slice(0, f)) + (
                ...
                f = 2 == e || (f = h.slice(0, b + 1).match(/\S*(\s)?$/))[1]
                    ? b
                    : f.input.length - f[0].length || 1 == e && b || f.input.length + (
                        f = h.slice(b).match(/^\S*/)
                    )[0].length;
            h = d.trim(h)
        }
    ...
    d.formatDuration = function (a, b, c, e, g, f) {
        ...
        "ss" == b && (a = d.formatNumber(a, f), 1 == a.split(k)[0].length && (
            a = "0" + a
        ));
    ...
    d.copyProperties = function (a, b) {
        for (var c in a) 
            a.hasOwnProperty(c) && "events" != c && void 0 !== a[c] && "function" != typeof a[c] && "cname" != c && (
                b[c] = a[c]
            )
    };
    ...
    d.removeCN = function (a, b, c) {
        b && (b = b.node) && c && (b = b.classList) && b.remove(
            a.classNamePrefix + "-" + c
        )
    };
...
(function () {
    ...
    d.AxisBase = d.Class({
        ...
        handleGuideOver: function (a) {
            ...
            this
                .chart
                .showBalloon(a.balloonText, e, !0, c, b);
        ...
        parseDatesDraw: function () {
            ...
            if (0 < this.gridCountR) 
                for (
                    B - 5 - k > this.autoRotateCount && !isNaN(this.autoRotateAngle) && (this.labelRotationR = this.autoRotateAngle),
                    a = k;
                    a <= B;
                    a++
                ) {
                    ...
                    "DD" == A && (p += 36E5);
                    p = d
                        .resetDateToMin(new Date(p), A, u, t)
                        .getTime();
                    "MM" == A && (g = (p - l) / y, 1.5 <= (p - l) / y && (
                    ...
                    if ("radar" == b.type) {
                        ...
                        this.rotate
                            ? "date" == this.type && "middle" == this.gridPosition && (
        ...
        checkPeriodChange: function (a, b, c, e, g) {
            ...
            "DD" == a && (b = 1);
            c = d
                .resetDateToMin(c, a, b, h)
                .getTime();
            b = d
                .resetDateToMin(f, a, b, h)
                .getTime();
            return "DD" == a && "hh" != g && c - b < d.getPeriodDuration(a, e) - d.getPeriodDuration(
                "hh",
                1
            )
                ? !1
        ...
        hideBalloon: function () {
            this.balloon && this.balloon.hide && this
                .balloon
                .hide();
            this.prevBY = this.prevBX = NaN
        },
    ...
    d.ValueAxis = d.Class({
        ...
        updateData: function () {
            ...
            if (this.synchronizationMultiplier && this.synchronizeWith) 
                ...
                "date" != this.type && this.strictMinMax && (
        ...
        draw: function () {
            ...
            if (this.logarithmic) {
                var e = this.treatZeroAs,
                    g = this
                        .getExtremes(0, this.data.length - 1)
                        .min;
            ...
            if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || -Infinity == this.max) 
                ...
                "date" == this.type && this.min == this.max && (
                ...
                if (this.logarithmic) {
                    ...
                    this.relativeStart = d.roundTo(
                        (Math.log(this.minReal) / Math.LN10 - Math.log(h) * Math.LOG10E) / r,
                        5
                    );
                    this.relativeEnd = d.roundTo(w / r, 5)
                } else 
                    this.relativeStart = d.roundTo(
                        d.fitToBounds((this.min - this.fullMin) / (this.fullMax - this.fullMin), 0, 1),
                        5
                    ),
                    this.relativeEnd = d.roundTo(
                        d.fitToBounds((this.max - this.fullMin) / (this.fullMax - this.fullMin), 0, 1),
                        5
                    );
        ...
        getMinorGridStep: function (a, b) {
            ...
            60 > b && c.shift();
            for (
                var e = Math.floor(Math.log(Math.abs(a)) * Math.LOG10E),
                d = 0;
                d < c.length;
                d++
            ) {
        ...
        stackGraphs: function (a) {
            ...
            if (r && ("regular" == b || "100%" == b)) 
                for (q = 0; q < k.length; q++) 
                    ...
                    n.hidden || (
                        m = n.type,
                        n.chart == this.chart && n.valueAxis == this && a == m && n.stackable && (l && (n.stackGraph = l), l = n)
                    );
        n = this.start - 10;
            l = this.end + 10;
                ...
                for (q = 0; q < k.length; q++) 
                    if (n = k[q], n.hidden) 
                        ...
                        if (m = this.data[p].axes[this.id].graphs[n.id], h = m.values.value, isNaN(h)) 
                            ...
                            f[p] = d.roundTo(f[p], w);
                            z = n.fillToGraph;
                            r && z && (z = this.data[p].axes[this.id].graphs[z.id]) && (
            ...
            for (p = this.start; p <= this.end; p++) 
                for (q = 0; q < k.length; q++) 
                    (n = k[q], n.hidden)
                        ...
                        : (
                            m = n.type,
                            n.chart == this.chart && n.valueAxis == this && a == m && n.stackable && (m = this.data[p].axes[this.id].graphs[n.id], h = m.values.value, isNaN(h) || (
                                c = h / f[p] * 100,
                                m.values.percents = c,
                                m.values.total = f[p],
                                n.newStack && (g[p] = NaN, e[p] = NaN),
                    ...
                    if (!isNaN(a.startTime) && (m = a.categoryAxis)) {
                        var n = m.minDuration(),
                            ...
                            q = d
                                ...
                                .getTime();
                        d
                            .resetDateToMin(new Date(n), m.minPeriod)
                            .getTime() > q && h++
                    }
        ...
        getMinMax: function () {
            ...
            for (e = 0; e < c.length; e++) {
                var g = c[e].type;
                ("line" == g || "step" == g || "smoothedLine" == g) && this.expandMinMax && (
                    a = !0
                )
            }
            a && (
        ...
        isNaN(this.minimum) || (this.min = this.minimum);
            ...
            0 < this.min && 0 < this.minReal - this.step && (
                this.minReal = this.min + this.step < this.minReal
                    ? this.min + this.step
                    : this.min
            );
            this.logarithmic && (
                    ...
                    if (f.hasOwnProperty(h)) {
                        ...
                        if (k.includeInMinMax && (!k.hidden || this.includeHidden)) {
                            ...
                            if (this.minMaxField) 
                                ...
                                for (var m in k) 
                                    k.hasOwnProperty(m) && "percents" != m && "total" != m && "error" != m && (
                                        l = k[m],
                                        l < c && (c = l),
                                        l > e && (e = l)
                                    )
        ...
        zoomToValues: function (a, b, c) {
            ...
            0 === this.relativeStart && 1 == this.relativeEnd && (
                this.maxZoom = this.minZoom = NaN
            ),
            !0
        },
...
(function () {
    ...
    d.RecItem = d.Class({
        construct: function (a, b, c, e, g, f, h, k, l, m, n, q) {
            ...
            if ("H" == Pa) {
                if (
                    0 <= b && b <= xa + 1 && (0 < B && 0 < y && b + l <= xa + 1 && (fa = d.line(z, [
                        b + l,
                        b + l
                    ], [
                        0, B
                                ...
                                ? (
                                    0 < n
                                        ? (
                                            ...
                                            a.centerRotatedLabels || (G += ha / 2 * Math.cos(V) - 4 + 2)
                                        )
                                        : 0 > n
                                            ? (
            ...
            0 === this.set.node.childNodes.length && this
                .set
                .remove()
        },
        graphics: function () {
    ...
    d.AmChart = d.Class({
        ...
        afterWrite: function (a) {
            ...
            if (
                ...
                b.appendChild(k);
                (b = this.exportConfig) && d.AmExport && !this.AmExport && (
                    this.AmExport = new d.AmExport(this, b)
                );
                this.amExport && d.AmExport && (
                    this.AmExport = d.extend(this.amExport, new d.AmExport(this), !0)
                );
                this.AmExport && this.AmExport.init && this
                    .AmExport
                    .init();
                if (e) {
        ...
        initChart: function () {
            ...
            (a = this.percentFormatter) && !isNaN(a.precision) && (
        ...
        measure: function () {
            ...
            if (a) {
                ...
                (c != this.previousWidth || e != this.previousHeight) && 0 < a && 0 < f && (
                    b.style.width = a + "px",
                    b.style.height = f + "px",
                    b.style.padding = 0,
                    g && g.setSize(a, f),
                ...
                this.balloon && this.balloon.setBounds && this
                    .balloon
                    .setBounds(2, 2, a - 2, f);
                this.updateWidth();
                this.balloon.chart = this;
        ...
        destroy: function () {
            ...
            this.clearTimeOuts();
            this.legend && this.legend.destroy && this
                .legend
                .destroy()
        },
        ...
        this.legend && this.legend.destroy && this
                .legend
                .destroy();
            this.AmExport && this.AmExport.clear && this
                .AmExport
                .clear()
        },
        ...
        drawLabel: function (a) {
            ...
            if (b.container && !1 !== a.enabled) {
                ...
                0 !== k && e.rotate(k);
                a.url
                    ? (e.setAttr("cursor", "pointer"), e.click(function () {
        ...
        updateWidth: function () {
            ...
            if (c) {
                ...
                if (("right" == k || "left" == k) && void 0 === c.divId) {
                    ...
                    this.balloon && this.balloon.setBounds && this
                        .balloon
                        .setBounds(2, 2, a - 2, this.realHeight);
                    "left" == k
            ...
            -.5 < this.tmx && this.tmx < this.divRealWidth + 1 && 0 < this.tmy && this.tmy < this.divRealHeight
                ? (
                    ...
                    4 > Math.abs(this.mouseX - this.tmx) && 4 > Math.abs(this.mouseY - this.tmy)
                        ? (
                            this.tapped = !0,
                            this.panRequired && this.panEventsEnabled && this.chartDiv && (
        ...
        resetTouchStyle: function () {
            this.panEventsEnabled && this.chartDiv && (
        ...
        validateNow: function (a, b) {
            ...
            var c = this.legend;
            c && c.position != this.prevLegendPosition && (
            ...
            if (a) {
                if (a.touches) {
                    var f = a
                        .touches
                        .item(1);
                    f && this.panEventsEnabled && this.boundingRect && (
...
(function () {
    ...
    d.AmGraph = d.Class({
        ...
        createRadarGraph: function () {
            ...
            for (m = this.start; m <= this.end; m++) {
                ...
                if (isNaN(q)) 
                    ...
                    var t = this
                            .valueAxis
                            .getCoordinate(q, this.noRounding) - this.height,
                    ...
                    if (!isNaN(p)) {
                        var w = this
                                .valueAxis
                                .getCoordinate(p, this.noRounding) - this.height,
            ...
            if (e) {
                ...
                if (e && "radar" != f.type) 
                    if (q) {
                        ...
                        !this.showAllValueLabels && e && (0 > b || b > this.width) && (
                            e.remove(),
                            e = null
                        )
                    }
                    ...
                    !this.showAllValueLabels && e && (0 > c || c > this.height) && (
                        e.remove(),
                        e = null
                    )
                }
        ...
        createSerialGraph: function () {
            ...
            if (!(J || "line" != h && "smoothedLine" != h && "step" != h || (
                ...
                if (Ia) {
                    ...
                    switch (h) {
                        ...
                        case "step":
                            if (!isNaN(W)) {
                                t
                                    ? (isNaN(A) || (x.push(A), u.push(F - wa)), u.push(F - wa), x.push(E), u.push(
                                        F + Ga
                                    ), x.push(E), !Ma || isNaN(N) || isNaN(O) || (
                                    ...
                                    : (
                                        ...
                                        u.push(F),
                                        !Ma || isNaN(N) || isNaN(O) || (isNaN(D) || (T.push(O - wa), U.push(D)), T.push(O - wa), U.push(N), T.push(
                                            O + Ga
                                        ), U.push(N))
                                    );
                                A = E;
                            ...
                            if (!isNaN(W)) {
                                ...
                                if (!(W < Qb && rb < Qb || W > Rb && rb > Rb)) {
                                    ...
                                    if (t) {
                                        "3d" == M
                                            ? (
                                                R = F - (r / 2 - this.depthCount + 1) * (k + V) + V / 2 + Q * Z,
                                                S = O + H * Z,
                                                Aa = Z
                                            )
                                        ...
                                        "3d" == M
                                            ? (
                                                S = E - (r / 2 - this.depthCount + 1) * (k + V) + V / 2 + H * Z,
                                                R = N + Q * Z,
                                                Aa = Z
                                            )
                                        ...
                                        K = d.roundTo(K, 2);
                                        ba = d.roundTo(ba, 2);
                                        S < n + Z * H && 0 < K && (this.showOnAxis && (R -= Q / 2), va = new d.Cuboid(
                                            g,
                                            K,
                                            ba,
                                            H - a.d3x,
                                            ...
                                            pb,
                                            aa
                                        ), v.columnHeight = Math.abs(ba), v.columnWidth = Math.abs(K))
                                    }
                                }
                                if (va) {
                                    za = va.set;
                                    ...
                                    if (!J) {
                                        ...
                                        "3d" == M && (
                                            t
                                                ? (
                                                    I = (this.end + 1 - L) * C - c - 1E3 * this.depthCount,
                                                    ya += H * Z,
                                                    ka += H * Z,
                                                    v.y += H * Z
                                                )
            ...
            if (!isNaN(b) && !isNaN(c) && ("none" != this.bullet || this.customBullet || a.bullet || a.customBullet)) {
                ...
                this.rotate
                    ...
                    : c = a.isNegative
                        ...
                        : c - f;
                q = this.bulletColorR;
                a.lineColor && void 0 === this.bulletColor && (
        ...
        showCustomBullets: function () {
            ...
            for (b = 0; b < a.length; b++) {
                ...
                c && c.customBulletGraphics && c
                    .customBulletGraphics
                    .show()
            }
        },
        ...
        handleRollOver: function (a, b) {
            ...
            if (a) {
                ...
                (c = c.chartCursor) && c.valueBalloonsEnabled || this.showGraphBalloon(
                    a,
                    "V",
                    !0
                )
                        ...
                        ? (
                            ...
                            isNaN(b) || isNaN(g)
                                ...
                                : (
                                    ...
                                    h.fixPrevious(),
                                    h.fixedPosition && (c = !1),
                                    !c && "radar" != f.type && (b < k - .5 || b > a + k || g < l - .5 || g > q + l)
...
(function () {
    ...
    d.ChartCursor = d.Class({
        ...
        fixVLine: function (a, b) {
            if (!isNaN(a) && this.vvLine) {
                if (isNaN(this.prevLineX)) {
                    ...
                    this.prevLineX != a && this
                        .vvLine
                        .translate(this.prevLineX, this.prevLineY);
                this.fx = a;
                this.prevLineX != a && (
        ...
        hideCursor: function (a) {
            this.forceShow = !1;
            this.chart.wasTouched && this.leaveAfterTouch || this.isHidden || this.leaveCursor || (
                this.hideCursorReal(),
                a
                    ? this.chart.handleCursorHide()
                    : this.fire({target: this, chart: this.chart, type: "onHideCursor"}),
            ...
            if (!this.pan) {
                ...
                if (b && 3 < Math.abs(b.width) && 3 < Math.abs(b.height)) {
                    ...
                    var b = {
                        ...
                        m;
                    this.hZoomEnabled && 4 < Math.abs(this.mouseX0 - this.mouseX) && (
                        b.startX = this.mouseX0 / this.width,
                        b.endX = this.mouseX / this.width,
                        m = !0
                    );
                    this.vZoomEnabled && 4 < Math.abs(this.mouseY0 - this.mouseY) && (
        ...
        syncWithCursorReal: function (a, b) {
            ...
            var d = a.mouseX,
                f = a.mouseY;
            this.rotate
                ? (d = NaN, this.vvLine && this.vvLine.hide(), this.hhLine && e && (
                    isNaN(a.fy)
                        ? this.hhLine.translate(0, a.mouseY)
                        : this.fixHLine(a.fy, 0)
                ))
                : (f = NaN, this.hhLine && this.hhLine.hide(), this.vvLine && c && (
                    isNaN(a.fx)
...
(function () {
    ...
    d.SimpleChartScrollbar = d.Class({
        ...
        iconRollOver: function () {
            this.rotate
                ? this.vResizeCursor && this
                    .chart
                    .setMouseCursor(this.vResizeCursor)
                : this.hResizeCursor && this
                    .chart
                    .setMouseCursor(this.hResizeCursor);
            this.handleMouseOver()
        },
        getDBox: function () {
            if (this.dragger) 
...
(function () {
    ...
    d.ChartScrollbar = d.Class({
        ...
        init: function () {
            ...
            (a = this.graph) && this.catScrollbar && (c = this.valueAxis, c || (
        ...
        draw: function () {
            ...
            if (!isNaN(a)) {
                ...
                if (this.show) {
                    ...
                    0 < this.animationDuration && !e && !isNaN(this.prevX) && (
...
(function () {
    ...
    d.AmCoordinateChart = d.Class({
        ...
        construct: function (a) {
            ...
            this.colors = (
                "#FF6600 #FCD202 #B0DE09 #0D8ECF #2A0CD0 #CD0D74 #CC0000 #00CC00 #0000CC #DDDDD" +
                "D #999999 #333333 #990000"
            ).split(" ");
                    ...
                    for (Q = 0; Q < g.length; Q++) {
                        ...
                        if (b.valueAxis.id == H) {
                            ...
                            if (!b.connect || b.forceGap && !isNaN(b.gapPeriod)) 
                                if (
                                    y && y[M] && 0 < P && B.time - w[M] >= z * P && (y[M].gap = !0),
                                    b.forceGap
                                ) {
                                    var P = 0,
                                        ma;
        ...
        processValues: function (a, b, c) {
            ...
            for (
                var h = "value error open close low high".split(" "),
                k = 0;
                k < h.length;
                k++
            ) {
        ...
        processFields: function (a, b, c) {
            ...
            e = (
                "lineColor color alpha fillColors description bullet customBullet bulletSize bu" +
                "lletConfig url labelColor dashLength pattern gap className columnIndex"
            ).split(" ");
    ...
    d.TrendLine = d.Class({
        ...
        draw: function () {
            ...
            if (!(isNaN(e) || isNaN(g) || isNaN(f) || isNaN(f))) {
                ...
                l = n / Math.abs(n);
                m = q / Math.abs(q);
                q = 90 * Math.PI / 180 - Math.asin(n / (n * q / Math.abs(n * q) * Math.sqrt(
                    Math.pow(n, 2) + Math.pow(q, 2)
                )));
        ...
        draw: function () {
            ...
            c && (
                ...
                a.balloonText && c.mouseover(function () {
                    a
                        .chart
                        .showBalloon(a.balloonText, a.balloonColor, !0)
                }).mouseout(function () {
                    a
                        .chart
                        .hideBalloon()
...
(function () {
    ...
    d.text = function (a, b, c, e, g, f, h, k) {
        ...
        void 0 !== b && (
            b = String(b),
            d.isIE && !d.isModern && (b = b.replace("&amp;", "&"), b = b.replace("&", "&amp;"))
        );
        c = {
            fill: c,
            "font-family": e,
    ...
    d.makeHD = function (a, b, c) {
        for (var d = [], g = [], f = 1; f < a.length; f++) 
            for (
                ...
                l = Number(a[f]),
                m = Number(b[f]),
                n = Math.round(Math.sqrt(
                    Math.pow(l - h, 2) + Math.pow(m - k, 2)
                ) / 50) + 1,
                l = (l - h) / n,
                m = (m - k) / n,
                q = 0;
    ...
    d.drop = function (a, b, c, d, g, f, h, k) {
        ...
        b += " A" + r + "," + r + ",0,0,0," + n + "," + q;
        return a
            .path(b, void 0, void 0, "1000,1000")
            .attr(c)
    };
    d.wedge = function (a, b, c, e, g, f, h, k, l, m, n, q, p, t) {
        ...
        if (0 < l) {
            ...
            for (var J = 0; J < ia; J += 10) {
                var aa = a
                    .path(P, void 0, void 0, "1000,1000")
                    .attr(H);
                e.push(aa);
                aa.translate(0, -J)
            }
            P = a
                .path(" M" + x + "," + A + " L" + x + "," + (
                    ...
                    B + l
                ) + " L" + y + "," + B + " L" + x + "," + A + " Z", void 0, void 0, "1000,1000")
                .attr(H);
            l = a
                .path(" M" + D + "," + C + " L" + D + "," + (
                    C + l
                    ...
                    u + l
                ) + " L" + I + "," + u + " L" + D + "," + C + " Z", void 0, void 0, "1000,1000")
                .attr(H);
            e.push(P);
            e.push(l)
        }
        z
            ? (
                M || (g = " A" + r(b - f) + "," + r(c - h) + "," + r(b + f) + "," + r(c + h) + "," +
                        r(y) + "," + r(B) + "," + r(D) + "," + r(C)),
                h = " M" + r(x) + "," + r(A) + " L" + r(y) + "," + r(B) + g + " L" + r(I) +
                    "," + r(u)
            )
            : h = " M" + x + "," + A + " L" + y + "," + B + (
                " A" + f + "," + h + ",0," + Q + ",1," + D + "," + C
        ...
        a = a
            .path(h + " Z", void 0, void 0, "1000,1000")
            .attr(m);
        if (n) {
            k = [];
    ...
    d.rgb2hex = function (a) {
        return (
            ...
            ? "#" + (
                "0" + parseInt(a[1], 10).toString(16)
            ).slice(-2) + ("0" + parseInt(a[2], 10).toString(16)).slice(-2) + (
                "0" + parseInt(a[3], 10).toString(16)
            ).slice(-2)
            : ""
    };
    d.adjustLuminosity = function (a, b) {
        ...
        6 > a.length && (
            a = String(a[0]) + String(a[0]) + String(a[1]) + String(a[1]) + String(a[2]) +
                String(a[2])
        );
        b = b || 0;
        var c = "#",
        ...
        for (g = 0; 3 > g; g++) 
            ...
            e = Math
                .round(Math.min(Math.max(0, e + e * b), 255))
                .toString(16),
        ...
        drawSegment: function (a, b, c) {
            ...
            if (2 < a.length) 
                for (var g = 0; g < a.length - 1; g++) {
                    ...
                    d += "C" + h[1].x + "," + h[1].y + "," + h[2].x + "," + h[2].y + "," + h[3].x + "," +
                            h[3].y + " "
                }
            else 
...
(function () {
    ...
    d.AmDraw = d.Class({
        construct: function (a, b, c, e) {
            ...
            d.hasSVG = !!document.createElementNS && !!document
                .createElementNS(
                    d.SVG_NS,
                    "svg"
                )
        ...
        addDefs: function (a) {
            if (d.hasSVG) {
                ...
                a && (a.addCodeCredits && b.appendChild(document.createTextNode(
...
(function () {
    ...
    d.AmDObject = d.Class({
        ...
        toPrevious: function () {
            var a = this.node;
            a && this.prevNextNode && (a = a.parentNode) && a.insertBefore(
                this.prevNextNode,
                null
            )
        },
        ...
        mouseover: function (a) {
            this
                .R
                .addListener(this, "mouseover", a);
            return this
        },
        mouseout: function (a) {
            this
                .R
                .addListener(this, "mouseout", a);
            return this
        },
        click: function (a) {
            this
                .R
                .addListener(this, "click", a);
            return this
        },
        dblclick: function (a) {
            this
                .R
                .addListener(this, "dblclick", a);
            return this
        },
        mousedown: function (a) {
            this
                .R
                .addListener(this, "mousedown", a);
            return this
        },
        mouseup: function (a) {
            this
                .R
                .addListener(this, "mouseup", a);
            return this
        },
        touchmove: function (a) {
            this
                .R
                .addListener(this, "touchmove", a);
            return this
        },
        touchstart: function (a) {
            this
                .R
                .addListener(this, "touchstart", a);
            return this
        },
        touchend: function (a) {
            this
                .R
                .addListener(this, "touchend", a);
            return this
        },
        keyup: function (a) {
            this
                .R
                .addListener(this, "keyup", a);
            return this
        },
        focus: function (a) {
            this
                .R
                .addListener(this, "focus", a);
            return this
        },
        blur: function (a) {
            this
                .R
                .addListener(this, "blur", a);
            return this
        },
        contextmenu: function (a) {
            this.node.addEventListener
                ? this
                    .node
                    .addEventListener("contextmenu", a, !0)
                : this
                    .R
                    .addListener(this, "contextmenu", a);
            return this
        },
        stop: function () {
    ...
    d.VMLRenderer = d.Class({
        ...
        setAttr: function (a, b, c) {
            ...
            if ("shape" == f) {
                    ...
                    "stroke-width" == b && (
                        e
                            ? f.weight = c
                            : f.setAttribute("weight", c)
                    );
                    "stroke-opacity" == b && (
                        e
                            ? f.opacity = c
                            : f.setAttribute("opacity", c)
                    );
                    "stroke-dasharray" == b && (
                        h = "solid",
                        0 < c && 3 > c && (h = "dot"),
                    ...
                    "fill" == b && (
                        e
                            ? a.color = c
                            : a.setAttribute("color", c)
                    );
                    "rx" == b && (
                        e
                            ? g.arcSize = c + "%"
                            : g.setAttribute("arcsize", c + "%")
                    )
                }
            }
        },
        ...
        rotate: function (a, b, c) {
            if (0 !== Number(b)) {
                ...
                a.cssText = a.cssText +
                        "; filter:progid:DXImageTransform.Microsoft.Matrix(M11='" + g + "', M12='" + -f + "', M21='" + f + "', M22='" + g + "', sizingmethod='auto expand');"
            }
        },
...
(function () {
    ...
    d.SVGRenderer = d.Class({
            ...
            for (a = b.length - 1; 0 <= a; a--) {
                ...
                if (g <= e) {
                    ...
                    if ("translate" == h) {
                        ...
                        m = 0 === m - h
                            ? m
                            : Math.round(d[c.effect](0, g, h, m - h, e));
                        c = 0 === l - k
                            ? l
                            : Math.round(d[c.effect](0, g, k, l - k, e));
                        h = "transform";
                        if (isNaN(m) || isNaN(c)) 
                            continue;
                        c = "translate(" + m + "," + c + ")"
        ...
        path: function (a, b) {
            a
                .node
                .setAttributeNS(d.SVG_XLINK, "xlink:href", b)
        },
        ...
        text: function (a, b, c) {
            ...
            e
                .node
                .setAttribute("y", Math.round(g / 2));
            this.attr(e, b);
            this
                .D
                .addToContainer(e.node, c);
            return e
        },
        setText: function (a, b) {
            var c = a.node;
...
(function () {
    ...
    d.AmLegend = d.Class({
        ...
        arrangeEntries: function () {
            ...
            e = l + e + g + 1;
            0 > e && (e = 0);
            "absolute" != a && "outside" != a && e > this.chart.divRealHeight && (
                h.style.top = "0px"
            );
            ...
            if (!1 !== a.visibleInLegend && !a.hideFromLegend) {
                ...
                if (e) {
                    ...
                    if ("line" == e || "step" == e || "smoothedLine" == e || "ohlc" == e) 
                        ...
                        m.push(t),
                        a.bullet && (a.hidden || (f = a.bulletColorR), t = d.bullet(
                            q,
                            a.bullet,
                            a.bulletSize,
                            f,
                    ...
                    (m = b.createMarker(g, f, h, void 0, void 0, void 0, z, l)) && m.translate(
                        p / 2,
                        p / 2
                    )
                }
                ...
                k = b.color;
                a.showBalloon && b.textClickEnabled && void 0 !== b.selectedColor && (
                    k = b.selectedColor
                );
                ...
                c.accessible && b.accessibleLabel && (
        ...
        rollOverLabel: function (a, b) {
            a.hidden || this.textClickEnabled && a.legendLabel && a
                .legendLabel
                .attr({fill: this.rollOverColor});
            this.dispatch("rollOverItem", a, b)
        },
                ...
                for (c = 0; c < a.length; c++) {
                    ...
                    if (e) 
                        ...
                        f.legendColorFunction && (
                            n = f.legendColorFunction(l, h, f.periodDataItem, f.periodPercentDataItem)
                        );
                        g.text(h);
                        if (!f.pattern && (
